...
const socialProofs = [
  {
    name: `Sam Altman`,
    company: `CEO de OpenAI.`,
    image: `/images/Sam_Altman.avif`,
    text: `Va a ser increiblemente importante en las proximas decadas, al menos
    , la para sociedad y como todos vivimos nuestras vidas, lo que hacemos
    y lo que es posible.`,
  },
  {
    name: `Satya Nadella`,
    company: `CEO de Microsoft.`,
    image: `/images/Satya-Nadella.webp`,
    text: `Lo que viene a continuacion no son areas lineales, no son progresos lineales
    . La IA hará un mundo mas abierto para todos.`,
  },
];
...
const SocialProof = () => {
  ...
  return (
    <div className={tw(`container mx-auto my-8`)}>
      <div className={tw(`max-w-7xl ml-4`)}>
        <section>
          <figure>
